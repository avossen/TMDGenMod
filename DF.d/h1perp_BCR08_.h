...
#ifndef _H1PERP_BCR08_H_
#define _H1PERP_BCR08_H_
...
namespace TMDGen {
   namespace DF {
      ...
      class h1perp_BCR08_t : public BCR08_t {
         NO_EQ_OP( h1perp_BCR08_t );
         NO_COPY_CONSTR( h1perp_BCR08_t );
