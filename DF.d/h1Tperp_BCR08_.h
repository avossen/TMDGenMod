...
#ifndef _H1TPERP_BCR08_H_
#define _H1TPERP_BCR08_H_
...
namespace TMDGen {
   namespace DF {
      ...
      class h1Tperp_BCR08_t : public BCR08_t {
         NO_EQ_OP( h1Tperp_BCR08_t );
         NO_COPY_CONSTR( h1Tperp_BCR08_t );
