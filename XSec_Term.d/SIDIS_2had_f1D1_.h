...
#ifndef _XSEC_TERM_SIDIS_2HAD_F1D1_H_
#define _XSEC_TERM_SIDIS_2HAD_F1D1_H_
...
namespace TMDGen {
   namespace XSec_Term {
      ...
      class SIDIS_2had_f1D1_t : public XSec_Term_t {
         ...
         double (SIDIS_2had_f1D1_t::*func_ptr)( const Var_t& var );
