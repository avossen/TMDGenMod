...
#ifndef _XSEC_TERM_SIDIS_2HAD_SIVERS_H_
#define _XSEC_TERM_SIDIS_2HAD_SIVERS_H_
...
namespace TMDGen {
   namespace XSec_Term {
      ...
      class SIDIS_2had_Sivers_t : public XSec_Term_t {
         ...
         const double *pol_factor,       // polarization factor, such as S_T or beam polarization, etc.
            ...
            *Siver_val,        // distribution function value
            *Re_D1_val,        // fragmentation function value
            *g_1T_val,         // distribution function value
            *Im_D1_val;        // fragmentation function value

         double overall_sign, D1_sign;

         // pointers to functions for terms varying with l, m
         double (SIDIS_2had_Sivers_t::*func_ptr)( const Var_t& var );
      ...
      public:
         SIDIS_2had_Sivers_t( int l, int m,
